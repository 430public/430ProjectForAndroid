 ...
 */
public class EntertainmentFragmentAdapter extends ListBaseAdapter {
    //定义静态方法ViewHolder
    ...
    public EntertainmentFragmentAdapter(Context context, List list, ListView listView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mTList.size() > 0) {
            EntertainmentBean.EntertainmentBeanResult bean = (EntertainmentBean.EntertainmentBeanResult) mTList.get(position);
