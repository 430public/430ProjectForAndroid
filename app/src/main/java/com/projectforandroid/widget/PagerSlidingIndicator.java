...
public class PagerSlidingIndicator extends HorizontalScrollView {
    ...
    //=========================以下为重写控件增加的====================================
    private int selectedTabTextColor = 0xFF00BCD4;//默认选中文字的颜色
    private int underBackgroundLineColor=0xFFA5A5A5;//默认导航条背景的框框的颜色
    private int underLineWidth=1;//默认底部线条宽度
    ...
    public int getUnderBackgroundLineColor() {
        return underBackgroundLineColor;
    }

    public void setUnderBackgroundLineColor(int underBackgroundLine) {
        this.underBackgroundLineColor = underBackgroundLine;
    }
